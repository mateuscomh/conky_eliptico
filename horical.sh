...
echo '${voffset -12}${goto 120}''${font mono:Bold:size=10}'$TOPLINE | sed 's/Su/${color red}Su${color}/g' | sed 's/Sa/${color red}Sa${color}/g'
echo '${voffset 8}${goto 120}''${font mono:bold:size=10}''${color C28C3A}'$OVER '${color FF0000}'$TODAY'${color}'$REST
